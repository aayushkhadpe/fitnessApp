...
class Workout(models.Model):
    ...
    difficulty_level = models.CharField(max_length=20, choices=DIFFICULTY_LEVEL_CHOICES, default="UNSPECIFIED")
    target = models.CharField(max_length=20, choices=TARGET_CHOICES, default="UNSPECIFIED")
    public_flag = models.BooleanField(default=False)
    personalized_flag = models.BooleanField(default=False)
