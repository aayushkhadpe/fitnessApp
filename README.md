...
A full-stack django web app for personal trainers and fitness enthusiasts. Also packaged as a Progressive Web App (PWA) and available on the App Store.

Live on [mysimplyfit.com/fitnessApp](https://www.mysimplyfit.com/fitnessApp/) (add to home screen for native app like experience) or

Install on iOS devices from the [App store](https://apps.apple.com/us/app/simply-fit-app/id6749191571)
...
- Manage schedule on the home page.
- Explore standard workouts and exercises.
- Create workouts for repeated use.
- Create personalized sessions for one time use.
- Manage clients (trainers only).
...
- Stack Overflow for troubleshooting hints
